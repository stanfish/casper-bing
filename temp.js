...
casper.start('https://account.microsoft.com/account/ManageMyAccount', function goToLoginPage() {
    writeToLog('Click to login');
    this.click('#signinhero');
});

function getSubmitButton() {
    var button = document.querySelectorAll("form input[type='submit']");
    return button;
}
